  ...
  return (
    <footer className="bg-stone-900 px-5 pb-6 pt-16 text-stone-200">
      <div className="mx-auto grid max-w-[1240px] gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <div><strong>Visit us</strong><p className="mt-4 flex gap-2 leading-6 text-stone-400"><FiMapPin className="mt-1 shrink-0" size={18} /><span>Pakistan Lahore Muridke<br />Online store</span></p><p className="text-stone-400">Cash on Delivery available.</p></div>
      </div>
